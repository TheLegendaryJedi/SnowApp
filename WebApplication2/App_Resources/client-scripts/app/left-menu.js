...
function LoadSelectedMenuItemOrNode() {
    ...
    // Teste
    var nivelMenu = $(item).parents('li').length //Usar este. Se = 3 é porque está no nível 3
    // var length = $(item).children('li').length
    //apply 'selected' style to target sub-menu || de acordo com o nível do menu
    if (nivelMenu==3)
    {
        item.addClass('SelectedNode3');
    }
    else
    {
